...
function guardarInformacionCategorias(){
    let var2 = {
        ...
        url:"http://150.230.91.85:8080/api/Category/save",
...
function guardarInformacionClientes(){
    let var4 = {
        ...
        url:"http://150.230.91.85:8080/api/Client/save",
...
function traerInformacionMensajes(){
    $.ajax({
        url:"http://150.230.91.85:8080/api/Message/all",
        type:"GET",
        datatype:"JSON",
        success:function(respuesta){
            console.log(respuesta);
...
function guardarInformacionMensajes(){
    let var5 = {
        ...
        url:"http://150.230.91.85:8080/api/Message/save",
